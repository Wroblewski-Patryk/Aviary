...
- `EVID-PAGE-DASHBOARD-PROOF` behavior verified: Dashboard route proof refreshed with route smoke marker aion-dashboard-canvas in a 14-route successful run (`web/scripts/route-smoke.mjs`). Command: `npm run smoke:routes`.
