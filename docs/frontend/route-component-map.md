...
| Tools components | `web/src/components/tools.tsx` | `ToolsSummaryCard`, `ToolsFactCard`, `ToolsDetailCard` |
...
| Tools components | `ToolsSummaryCard`, `ToolsFactCard`, `ToolsDetailCard` in `web/src/components/tools.tsx` | `/tools` |
