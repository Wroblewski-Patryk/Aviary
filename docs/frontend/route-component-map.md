...
| Tools components | `web/src/components/tools.tsx` | `ToolsSummaryCard`, `ToolsFactCard` |
...
| Tools components | `ToolsSummaryCard`, `ToolsFactCard` in `web/src/components/tools.tsx` | `/tools` |
