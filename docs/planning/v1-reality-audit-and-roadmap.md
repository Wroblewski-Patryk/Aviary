...
| PRJ-1029 | Align integrations route with shared module shell components | READY_AFTER_PRJ-1028 | use existing shared overview/stat/dot-row components for `/integrations` while route data and provider semantics stay in `App()` |
