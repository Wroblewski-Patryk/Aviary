...
| PRJ-1041 | Extract dashboard progress list component | READY_AFTER_PRJ-1040 | move dashboard progress row presentation into `web/src/components/dashboard.tsx` while `dashboardGoalRows` stays in `App()` |
