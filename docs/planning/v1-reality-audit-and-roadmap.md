...
| PRJ-1018 | Audit remaining frontend architecture gaps after chat cleanup | READY_AFTER_PRJ-1017 | re-check `web/src/App.tsx` route-local clusters and select the next v1 architecture slice |
