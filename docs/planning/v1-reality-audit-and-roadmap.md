...
| PRJ-973 | Extract shell chrome component cluster from `web/src/App.tsx` | READY_AFTER_PRJ-972 | wordmark, nav button, and utility chrome move behind route smoke without route behavior change |
