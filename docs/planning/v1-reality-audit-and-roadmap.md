...
| PRJ-995 | Extract shared module side-panel presentation for insights and automations | READY_AFTER_PRJ-994 | side-panel and row chrome moves behind route-keyed shared components while derived row data remains in `App()` |
