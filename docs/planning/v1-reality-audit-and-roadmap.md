...
| PRJ-986 | Extract tools item fact-card component cluster from `web/src/App.tsx` | READY_AFTER_PRJ-985 | tools item fact cards move behind explicit props without toggle/link behavior change |
