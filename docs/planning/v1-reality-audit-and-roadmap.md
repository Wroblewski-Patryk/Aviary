...
| PRJ-1019 | Extract shared module overview bar component | READY_AFTER_PRJ-1018 | add route-keyed `ModuleOverviewBar` for memory/reflections/plans/goals overview headers while preserving CSS classes and route data ownership |
