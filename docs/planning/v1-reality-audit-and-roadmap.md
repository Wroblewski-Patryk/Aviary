...
| PRJ-1011 | Extract chat topbar presentation from `web/src/App.tsx` | READY_AFTER_PRJ-1010 | add `ChatTopbar` with title, active summary, linked-channel label, and preferred-language label passed as explicit props |
