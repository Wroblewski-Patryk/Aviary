...
- `parent_of` -> [[pyfunc-backend-tests-test-architecture-graph-query-py-test-current-gra-7929b970|PYFUNC-BACKEND-TESTS-TEST-ARCHITECTURE-GRAPH-QUERY-PY-TEST-CURRENT-GRA-7929B970]]: `backend/tests/test_architecture_graph_query.py` contains function `test_current_graph_gap_audit_smoke_returns_curated_gaps`.
