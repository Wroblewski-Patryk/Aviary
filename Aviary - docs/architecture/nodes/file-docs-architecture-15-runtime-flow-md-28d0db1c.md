---
id: "FILE-DOCS-ARCHITECTURE-15-RUNTIME-FLOW-MD-28D0DB1C"
...
Repository file `docs/architecture/15_runtime_flow.md` auto-discovered for architecture graph inventory.
