...
[[doc-arch-graph-system|DOC-ARCH-GRAPH-SYSTEM]] -> `docs/architecture/registry/nodes.csv` -> [[script-generate-arch-graph|SCRIPT-GENERATE-ARCH-GRAPH]] -> [[test-arch-graph-generator|TEST-ARCH-GRAPH-GENERATOR]] -> `docs/architecture/nodes`
...
- connection: REL-GRAPH-001..003
- documentation: DOC-ARCH-GRAPH-SYSTEM
- missing links: Full project semantic curation remains iterative expansion but workflow mechanics are verified
