...
- [Architecture Graph Evidence System](architecture/graph-system.md) - CSV-first
  Obsidian architecture/evidence/research map for nodes, relations, function
  chains, graph exports, and systemic agent analysis.
- [Architecture Registry](architecture/registry/README.md) - canonical CSV
  source files for graph nodes, relations, chains, evidence, research claims,
  and typed views.
- [Function Chains](architecture/chains/index.md) and
  [Architecture Relations](architecture/relations/index.md) - generated
  execution-chain and dependency indexes.
- [Architecture Graph JSON](architecture/graphs/architecture-graph.json) and
  [Mermaid Graph](architecture/graphs/architecture-graph.mmd) - generated graph
  exports for future tooling.
