...
22. `.agents/state/active-mission.md`
23. `.agents/state/responsibility-learning.md`
24. `.agents/state/agent-evals.md`
...
- Default to coordinator-first execution for broad or multi-layer work: the
  ...
  separable, integrates their output, and keeps final done-state local.
